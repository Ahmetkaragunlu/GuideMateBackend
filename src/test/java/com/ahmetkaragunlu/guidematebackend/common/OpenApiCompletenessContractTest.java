...
class OpenApiCompletenessContractTest {
    ...
    void publishesCoreApiSurfaceAndHidesInternalSensitiveFields() throws Exception {
        String document = mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/guides/me/tours']").exists())
                .andExpect(jsonPath("$.paths['/api/v1/guides/me/tours/{tourId}/reviews']").exists())
                .andExpect(jsonPath("$.paths['/api/v1/guide/tours']").doesNotExist())
                .andExpect(jsonPath("$.paths['/api/v1/guide/tours/{tourId}/reviews']").doesNotExist())
