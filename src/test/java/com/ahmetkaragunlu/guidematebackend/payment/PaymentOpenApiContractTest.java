...
class PaymentOpenApiContractTest {
    ...
    void publishesPaymentWalletAndGuideFinanceContracts() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/payment-methods/cards/{savedPaymentMethodId}/default']")
                        .doesNotExist())
                .andExpect(jsonPath("$.components.schemas.SavedPaymentMethodResponse.properties.defaultMethod")
                        .doesNotExist())
                ...
                .andExpect(jsonPath(
                        "$.components.schemas.MonthlyGuideEarningResponse.properties.netEarningsMinor"
                ).exists())
                .andExpect(jsonPath(
